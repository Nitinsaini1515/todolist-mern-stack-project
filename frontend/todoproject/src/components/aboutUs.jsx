...
const AboutUs = () => {
  return (
    <div className="max-w-4xl w-full mx-auto p-4 sm:p-6 md:p-8 bg-white rounded-xl shadow-lg mt-10">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 text-gray-800">About Us</h1>

      {/* Introduction Field */}
      <div className="mb-6 text-center">
        <div className="inline-block bg-gray-100 rounded-lg px-4 sm:px-6 py-4 shadow max-w-full">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-1">Hi, I'm Nitin saini !</h2>
      ...
      <div className="text-gray-700 text-base sm:text-lg mb-6 text-center">
      ...
      <div className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2">Our Vision</h2>
        <p className="text-sm sm:text-base text-gray-600">
      ...
      <div className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2">Why Choose Us?</h2>
        <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-gray-600">
      ...
      <div className="flex flex-wrap justify-center gap-6 mt-8">
        ...
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/nitin-saini-ba1a64354?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
